      ...
      <div className="grid py-2 px-2 items-center grid-cols-9 md:text-[0.66rem]  text-[0.6rem] gap-x-2 bg-white">
        ...
        >
          ...
          <input
            ...
            className="text-center"
            onChange={(e) =>
              !isDocEditable ? updateScoreAOwn(e.target.value) : null
            }
            name="score_a_own"
          />
        </div>
        ...
        >
          <input
            ...
            className="text-center"
            onChange={(e) =>
              !isDocEditable ? updateScoreBOwn(e.target.value) : null
            }
            value={Score_b_own}
            name="score_b_own"
          />
        ...
        >
          <input
            type="number"
            onChange={(e) =>
              !isDocEditable ? updateScoreAResult(e.target.value) : null
            }
            className="text-center"
        ...
        >
          <input
            type="number"
            onChange={(e) =>
              !isDocEditable ? updateScoreBResult(e.target.value) : null
            }
            className="text-center"
...
export function Listeners({ message }) {
  ...
  return (
    <p aria-live="polite" className="text-sm p-1 text-red-400 font-semibold">
      {message}
