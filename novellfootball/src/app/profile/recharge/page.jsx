  ...
  return (
    <div className="h-screen w-screen bg-[#F8FCFF] pb-[7rem] overflow-y-scroll ">
      ...
      <div className="w-[90%]   mr-auto ml-auto my-3  ">
        ...
        <div>
          <h3>Enter Amount</h3>
          <div style={{boxShadow:"0 4px 10px rgb(0,0,0,.1) "}} className="flex border-2 border-[#2785F6] w-[98%] pl-2 mr-auto ml-auto place-items-center my-1 rounded-lg "  ><TbCoinRupeeFilled className="text-3xl text-[#2785F6] " /> <input type="number"  placeholder="10000" className=" py-2 w-[80%] ml-2 bg-transparent outline-none focus-within " /> </div>
          <div style={{boxShadow:"0 10px 5px rgb(0,0,0,0.08)"}}  className="flex justify-between px-2 py-3 place-items-center mt-2 w-[98%] mr-auto ml-auto rounded-lg  " >
            <p>Payment link 1</p>
