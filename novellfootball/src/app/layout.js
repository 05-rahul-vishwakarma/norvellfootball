    ...
    return (
        <html lang="en">
           <head>
            ...
            />
            <title>
                Housers - Live Football Betting on Every League Worldwide
            </title>
            <meta
                name="description"
                content="Housers offers live betting on ongoing football matches from leagues around the world. Bet on your favorite teams and win big with our platform."
            />
            <meta
                name="keywords"
                content="football betting, live football bets, online betting, soccer betting, bet on football, live sports betting, Housers"
            />
            <meta name="author" content="Housers" />

            <meta
                property="og:title"
                content="Housers - Live Football Betting on Every League Worldwide"
            />
            <meta
                property="og:description"
                content="Join Housers for live betting on matches from leagues around the globe. Bet on your favorite teams in real-time and enjoy the excitement of winning."
            />
            <meta
                property="og:image"
