...
const OlarkChat = () => {
  useEffect(() => {
    if (!window.olark) {
      ...
      script.onload = () => {
        window.olark.identify("2324-636-10-2872");
      };
    }
  }, []);
...
//   })(window,document,"static.olark.com/jsclient/loader.js");/* custom configuration goes here (www.olark.com/documentation) */olark.identify('2324-636-10-2872');</script><!-- end olark code -->
