  ...
  return (
    <div className="border-2 border-gray-[#e2dbd3] h-[60%] w-[90%] mr-auto ml-auto rounded-[10px] mt-[.5rem] bg-[#fbf3eb] shadow-sm ">
      ...
      <div className=" mt-[.3rem] w-[87%] mr-auto ml-auto ">
        <div className="flex  justify-between text-[.7rem] font-[600] " style={{color:"gray"}} >
        ...
        <div className="flex  justify-between text-[.7rem] font-[600] "style={{color:"gray"}}>
           ...
           <p className="w-[50%]  h-[20px] text-nowrap flex " >Estimated Amount<p className="text-nowrap ml-[.4rem] " style={{color:"#00db58"}} >1029938</p> </p>
        </div>
        ...
        <div className="flex  justify-between text-[.9rem] font-extrabold leading-5 ">
           ...
           <p className="w-[50%] flex place-items-center ">Odds <p className=" ml-[.3rem] "  style={{color:"#00db58"}} > 5.64%</p> </p>
        </div>
      </div>
